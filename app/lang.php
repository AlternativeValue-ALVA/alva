...
define('REGISTER_LINK', '<a href="register.php">register</a>');
define('LOGIN_LINK', '<a href="login.php">login</a>');
define('MEMBER_LINK', '<a href="members.php">member section</a>');
define('LOGOUT_LINK', '<a href="logout.php">logout</a>');
define('KNOWLEDGE_LINK', '<a href="http://www.quadodo.com/s.php" target="_blank" class="main">Support Area</a>');
 ...
 * Powered by link
 */
define('POWERED_BY', 'Made by <a href="http://m0k1.asia">m0k1.asia</a> (v%1$s)');
...
define('CHANGE_PASSWORD_LINK_CODE', '<a href="change_password.php?code=%1$s">try again</a>');
define('CHANGE_PASSWORD_LINK', '<a href="change_password.php">try again</a>');
 ...
 */
define('PAGINATION_ONE_PAGE', ' <li class="active"><a href="members.php?page=1">1</a></li>');
