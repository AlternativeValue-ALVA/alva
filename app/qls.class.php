...
class qls {
	...
	$this->main_directory = str_replace('/app', '', dirname(__FILE__));
	 ...
	 * @return the ID in the form of an integer
	 */
	 ...
	 * @return the name of the page (string)
	 */
	 ...
	 * @return the ID of the group, in integer form
	 */
	 ...
	 * @return the name of the group (string)
	 */
	 ...
	 * @return the ID of the mask in integer form
	 */
	 ...
	 * @return the name of the mask (string)
	 */
	 ...
	 * @return file data on success, false on failure
	 */
...
SCRIPT;
	 ...
	 * @return array of information about the users
	 */
