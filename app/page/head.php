...
$users_result = $qls->SQL->query("SELECT * FROM `{$qls->config['sql_prefix']}pm`WHERE (kome = '$user') ORDER BY `id` DESC LIMIT {$offset},{$perpage}");
...
?>
		<li>
								...
								<span class="time"><?php echo $row['datetime']; ?></span>
								</span>
								<span class="message">
