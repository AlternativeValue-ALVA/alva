                     ...
                     <div id="tab_2_2" class="tab-pane active">
                        ...
                        <div class="portlet-body">
                           <table class="table table-striped table-hover">
                              ...
                              <tbody>
<?php foreach ($this->members as $key => $users_row): ?>
<tr>							
	<td><?php echo $users_row['id']; ?></td>
	<td><img src="/crc/<?php echo md5($users_row['username']); ?>_s.jpg" alt="" /></td>                                    
	<td><a href="/profile/<?php echo stripslashes($users_row['username']); ?>"><?php echo stripslashes($users_row['username']); ?></td>
    <td><?php echo $users_row['firstname']; ?></td>
    <td><?php echo $users_row['alve']; ?></td>
    <td><?php
...
?></span></td>
    <td><a class="btn mini red-stripe" href="/profile/<?php echo stripslashes($users_row['username']); ?>">Profil</a></td>
</tr>
<?php endforeach; ?>
